...
const props = defineProps<{
    variant: any;
    id: number | string;
    deleteVariant: (id: number | string) => void;
}>()

const currentVariant = ref(props.variant);

const emit = defineEmits<{
    (e: 'change', id: number | string, key: string, value: string): void
}>();
...
<template>
    <el-form class="form">
        ...
        <div class="pickers">
            <el-radio-group v-model="currentVariant.choices.Size" aria-label="Size" disabled>
                <el-radio-button value="Large">large</el-radio-button>
                <el-radio-button value="Medium">medium</el-radio-button>
                <el-radio-button value="Small">small</el-radio-button>
            </el-radio-group>
            <el-radio-group v-model="currentVariant.choices.Color" aria-label="Color" disabled> 
